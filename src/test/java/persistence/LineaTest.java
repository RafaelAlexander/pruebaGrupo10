...
public class LineaTest extends AbstractPersistenceTest implements WithGlobalEntityManager {
  ...
  public void insertarTransportePublicoTest() {
    ...
    entityManager().persist(linea114);
    Linea lineaTrucha = entityManager().find(Linea.class, linea114.getId());
    assertEquals(linea114.getId(), lineaTrucha.getId());
  }
